...
class HybridauthComponent extends Component {
    ...
    protected function init(){
        ...
        if(Configure::read('hybridauth') == null){
            $provider = [
                'OpenID' => [
                    'enabled' => true
                ],
                'Google' => [
                    'enabled' => true,
                    'keys' => [
                        'id' => '920849047747-o6fqimf4hr021daa32vmmhg5a3co2afr.apps.googleusercontent.com',
                        'secret' => 'gcrBykm62G9i280Dz_iq0i-U'
                    ]
                ],
                'Facebook' => [
                    'enabled' => true,
                    'keys' => [
                        'id' => '690765634458238',
                        'secret' => '2a50e3ed5a410ca9429f4271654aeadb'
                    ],
                    'scope' => 'email, user_about_me, user_birthday, user_hometown'
                ],
            ];
        }else{
            $provider = Configure::read('hybridauth');
        }

        $config = array(
            "base_url" => Router::url("/users/socialEndpoint", true),
            "providers" => $provider,
