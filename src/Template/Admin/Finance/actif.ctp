...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">Actifs</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Actifs <small>Entrée financière et Toute source de revenue...</small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Liste Des Actifs</h4>
            </div>
                        ...
                        <?php foreach($actifs as $actif){ ?>
                            <tr class="gradeC">
                                ...
                                <td>
                                    ...
                                    <a href="<?= $this->Url->build(['controller' => 'Finance', 'action' => 'actif', 'actif' => $actif->id]) ?>" class="btn btn-success btn-icon btn-circle"><i class="fa fa-edit"></i></a>
                                    <a href="<?= $this->Url->build(['controller' => 'Finance', 'action' => 'delete', 'actif' => $actif->id]) ?>" class="btn btn-warning btn-icon btn-circle"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Total Des Actifs</h4>
            </div>
            <div class="panel-body">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Ajouter un actif</h4>
            </div>
            <div class="panel-body">
                <?= $this->form->create('Actif', ['url' => ['controller' => 'Finance', 'action' => 'actif']]); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-2">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier un Actif</h4>
            </div>
            <div class="panel-body">
                <?php if(isset($actif_edit)){ ?>
                    <?= $this->form->create('Actif', ['url' => ['controller' => 'Finance', 'action' => 'actif']]); ?>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Libelle</label>
                        <div class="col-md-9">
