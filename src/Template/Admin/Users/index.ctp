...
<?= $this->Html->css('admin/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css', ['block' => true]) ?>
<?= $this->Html->css('admin/assets/plugins/bootstrap-calendar/css/bootstrap_calendar.css', ['block' => true]) ?>
<?= $this->Html->css('admin/assets/plugins/gritter/css/jquery.gritter.css', ['block' => true]) ?>
<?= $this->Html->css('admin/assets/plugins/morris/morris.css', ['block' => true]) ?>
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Tableau de Bord <small>Bienvenue sur Maestro...</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
    <!-- begin col-3 -->
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
<?= $this->Html->script('admin/assets/plugins/morris/raphael.min.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/plugins/morris/morris.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/plugins/jquery-jvectormap/jquery-jvectormap-world-merc-en.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/plugins/bootstrap-calendar/js/bootstrap_calendar.min.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/js/dashboard-v2.min.js', ['block' => true]) ?>
<?= $this->Html->script('admin/assets/js/apps.min.js', ['block' => true]) ?>
<!-- ================== END PAGE LEVEL JS ================== -->
