...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Etudes <small>gérer les études personnels</small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-offset-1 col-md-10">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Liste Des Etudes Personnels</h4>
            </div>
                        ...
                        <?php foreach($etudes as $etude){ ?>
                            <tr class="gradeC">
                                ...
                                <td>
                                    ...
                                    <a href="<?= $this->Url->build(['controller' => 'Etude', 'action' => 'etudePersonnel', 'etudep' => $etude->id]) ?>" class="btn btn-success btn-icon btn-circle"><i class="fa fa-edit"></i></a>
                                    <a href="<?= $this->Url->build(['controller' => 'Etude', 'action' => 'delete', 'etudep' => $etude->id]) ?>" class="btn btn-warning btn-icon btn-circle"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            ...
            <div class="panel-body">
                <?= $this->form->create('Etude_personnel'); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-2">
            ...
            <div class="panel-body">
                <?php if(isset($etude_edit)){ ?>
                    <?= $this->form->create($etude_edit); ?>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Libelle</label>
                        <div class="col-md-9">
                            <?= $this->form->input('titre', array(
