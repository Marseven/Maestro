...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Projets <small>Tableau de bord des projets personnels et professionnels...</small></h1>
<!-- end page-header -->
                        ...
                        <?php foreach($projets as $projet){ ?>
                            <tr class="gradeC">
                                ...
                                <td>
                                    ...
                                    <a href="<?= $this->Url->build(['controller' => 'Projet', 'action' => 'projet', 'projet' => $projet->id]) ?>" class="btn btn-success btn-icon btn-circle"><i class="fa fa-edit"></i></a>
                                    <a href="<?= $this->Url->build(['controller' => 'Projet', 'action' => 'delete', 'projet' => $projet->id]) ?>" class="btn btn-warning btn-icon btn-circle"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Liste Des Projets Web | Mar@Seven Serveur</h4>
            </div>
            <div class="panel-body">
                <ul>
                    <?= include_once('C:\wamp64\www\list_projets.php') ?>
                </ul>
            </div>
        </div>
        <!-- end panel -->
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Créer un projet</h4>
            </div>
            <div class="panel-body">
                <?= $this->form->create('Projet', ['url' => ['controller' => 'Projet', 'action' => 'projet']]); ?>
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Type de Projet</label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Acteur du Projet</label>
                    <div class="col-md-9">
                        <?= $this->form->input('acteur', array(
                            'class' => 'form-control',
                            'placeholder' => 'Acteur *',
                            'label' => '',
                        )); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-2">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Modifier une Projet</h4>
            </div>
            <div class="panel-body">
                <?php if(isset($projet_edit)){ ?>
                    <?= $this->form->create($projet_edit, ['url' => ['controller' => 'Projet', 'action' => 'projet']]); ?>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Titre</label>
                        <div class="col-md-9">
                            <?= $this->form->input('titre', array(
